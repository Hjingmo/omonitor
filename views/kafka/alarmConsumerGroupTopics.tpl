                    ...
                    <table class="table table-striped table-bordered table-hover " id="editable" >
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"> Topic名称 </th>
                        ...
                        {{range $k,$v := .topics}}
	                        ...
	                        <tr class="gradeX">
								...
								<td class="text-center"> {{$v.Topicname}} </td>
								<td class="text-center"> 否 </td>
	                            <td class="text-center"> {{$v.Alarmval}} </td>
								<td class="text-center"> {{$v.Comment}} </td>
								<td class="text-center">
		                            <a href="/alarm/consumertopicedit?id={{$v.Id}}&groupid={{$v.Groupid}}" class="btn btn-xs btn-info">编辑</a>
		                            <a value="/alarm/consumertopicdel?id={{$v.Id}}&groupid={{$v.Groupid}}" class="btn btn-xs btn-danger server_del">删除</a>
		                        </td>
	                        </tr>
							{{else}}
							<tr class="danger">
