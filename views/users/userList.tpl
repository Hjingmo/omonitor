        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                    <a href="/user/adduser" class="btn btn-sm btn-primary "> 添加用户 </a>
                    ...
                    <table class="table table-striped table-bordered table-hover " id="editable" >
                        ...
                        <tr class="gradeX">
							...
							<td class="text-center"> {{$v.Firstname}}{{$v.Lastname}} </td>
							<td class="text-center"> {{$v.Lastlogin}}</td>
							<td class="text-center"> {{$v.Mobile}} </td>
                            <td class="text-center"> {{$v.Email}} </td>
							<td class="text-center">
	                            <a href="/user/edituser?id={{$v.Id}}" class="btn btn-xs btn-info">编辑</a>
	                            <a value="/user/deluser?id={{$v.Id}}" class="btn btn-xs btn-danger server_del">删除</a>
	                        </td>
                        </tr>
						{{end}}
                        </tbody>
