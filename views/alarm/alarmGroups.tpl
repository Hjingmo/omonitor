        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                    <a href="/alarm/addgroup" class="btn btn-sm btn-primary "> 添加报警组 </a>
                    ...
                    <table class="table table-striped table-bordered table-hover " id="editable" >
                        ...
                        <tr class="gradeX">
							...
							<td class="text-center"> <a href="/alarm/groupusers?id={{$v.Id}}">{{$v.Group}}</a> </td>
							{{if eq $v.Sms 1}}
							...
							<td class="text-center">
	                            <a href="/alarm/editgroup?id={{$v.Id}}" class="btn btn-xs btn-info">编辑</a>
	                            <a value="/alarm/delgroup?id={{$v.Id}}" class="btn btn-xs btn-danger server_del">删除</a>
	                        </td>
                        </tr>
						{{end}}
                        </tbody>
